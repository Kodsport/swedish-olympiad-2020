...
\section*{Indata}
På första raden finns de två heltalen $n$ och $k$ ($1 \leq n,k \leq 2 \cdot 10^5$), antalet kalas och antalet TV-serier som finns. TV-serierna är numrerade från $1$ till $k$.
...
De följande $n$ raderna beskriver kalasen i ordning. Rad $i$ börjar med två heltal $1 \leq d_i \leq 2 \cdot 10^5$ och $c_i \ge 1$, vilken dag kalaset är och antalet TV-serier som kommer att diskuteras. Sedan följer $c_i$ olika heltal på samma rad, de TV-serier som kommer diskuteras på kalaset. Summan av alla $c_i$ är inte större än $2 \cdot 10^5$.
